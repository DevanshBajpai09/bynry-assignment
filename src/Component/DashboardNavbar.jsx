...
const DashboardNavbar = ({ onSearch }) => {
  ...
  return (
    <div className="flex items-center justify-between py-4 px-10 bg-white shadow-2xl ">
      {/* Logo */}
      <a href="/" className="flex items-center font-bold text-3xl  text-black">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button onClick={() => navigate('/admin')} className="flex cursor-pointer items-center gap-2 bg-black text-white rounded-none px-5 py-2 transition-all">
